...
const de: Record<string, string> = {
  ...
  'update.available': '{version} - Update verfügbar',
  'update.downloading': '{percent}%',
  'update.downloaded': 'Zum Updaten App Neustarten',
  'update.error': 'Update-Fehler',
  'update.titleChecking': 'Suche nach Updates...',
  'update.titleAvailable': '{version} - Update verfügbar',
  'update.titleDownloading': 'Update wird heruntergeladen...',
  'update.titleDownloaded': 'Zum Updaten App Neustarten',
  'update.titleNotAvailable': 'Aktuell - nach Updates suchen',
...
const en: Record<string, string> = {
  ...
  'update.downloading': '{percent}%',
  'update.downloaded': 'To Update restart app',
  'update.error': 'Update error',
  'update.titleChecking': 'Checking for updates...',
  'update.titleAvailable': '{version} - Update available',
  'update.titleDownloading': 'Downloading update...',
  'update.titleDownloaded': 'To Update restart app',
  'update.titleNotAvailable': 'Up to date - check for updates',
